...
3. 사용자에게 반드시 아래 형식을 그대로 복사해서 출력 (각 줄 사이에 빈 줄 포함):
...
4. 사용자가 y, yes, 응, ㅇㅇ 중 하나를 입력하면:
   ...
   - 커밋 완료 후 반드시 아래 형식을 그대로 복사해서 출력 (각 줄 사이에 빈 줄 포함):
...
❌ 취소: n / 아니 / ㄴㄴ
   ...
   - n, no, 아니, ㄴㄴ 중 하나를 입력하면 "Push가 취소되었습니다." 출력
5. 3번에서 사용자가 n, no, 아니, ㄴㄴ 중 하나를 입력하면 "커밋이 취소되었습니다." 출력
