export const WORK_TIMELINE = [
    ...
    projects: [
      {
        ...
        result: "다양한 기업 환경에 즉각 대응 가능한 유연한 UI 구조 확보. 대규모 사용자 트래픽 환경에서도 안정적인 화면 렌더링 성능 유지.",
      },
      {
        ...
        result: "주력 상품의 디자인 아이덴티티 통일. 재사용 가능한 컴포넌트 구조화를 통해 후속 프로젝트 UI 개발 속도 30% 이상 향상.",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        action: "vw(Viewport Width) 단위를 적극 활용하여 iOS 및 안드로이드의 다양한 해상도에 가변적으로 대응하는 인터페이스 구현. 웹뷰 환경에서의 렌더링 최적화.",
      ...
      },
      {
        ...
        action: "다국어 지원 및 마크다운(Markdown) 문법 렌더링을 고려한 의미론적 마크업 설계. IE10부터 최신 크롬까지 대응하는 크로스브라우징 구현.",
      ...
      },
      {
        ...
        action: "복잡한 수치와 옵션 선택이 필요한 컨피규레이터 특성을 반영한 반응형 웹 설계. 글로벌 사용자를 위한 다국어 대응 및 IE 호환성 확보.",
      ...
      },
      {
        ...
        action: "IE9을 포함한 광범위한 브라우저 대응(크로스브라우징) 및 모바일 웹 최적화. 브랜드 아이덴티티를 유지하면서 구매 전환을 돕는 UI 퍼블리싱. (기여도 60%)",
    ...
    projects: [
      {
        ...
        action: "금융 서비스에 최적화된 UX Basic 가이드라인에 따른 UI 퍼블리싱 수행. 일관된 사용자 경험을 위한 공통 컴포넌트 마크업 구조 설계.",
      ...
      },
      {
        ...
        action: "PC 버전 고도화 구축 작업에 따른 신규 UI 반영 및 기존 기능의 유지보수 수행. 잦은 콘텐츠 업데이트에 대응하는 유연한 마크업 관리.",
    ...
    projects: [
      {
        ...
        action: "IE8부터 최신 브라우저까지 대응하는 광범위한 크로스브라우징 유지보수 및 상시 운영. PC 버전 리뉴얼 및 모바일 웹/앱 UI 신규 구축 전담. 복잡한 인터랙션 구현 및 웹 표준 준수.",
        result: "하위 브라우저(IE8~11) 지원을 통한 사용자 접근성 극대화 및 서비스 연속성 확보. 모바일 환경에 최적화된 인터페이스 구축을 통해 서비스 이용률 및 사용자 만족도 개선.",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        action: "모바일 환경에 최적화된 결제 및 포인트 관리 UI 퍼블리싱. 사용자 편의성을 고려한 직관적인 메뉴 구조 및 인터랙션 구현.",
      ...
      },
      {
        ...
        action: "하이브리드 앱 환경에 최적화된 이벤트 페이지 신규 구축 및 운영. 매주 진행되는 다양한 형태의 프로모션 UI 제작.",
        result: "하이브리드 앱 특유의 제약 사항을 극복한 유연한 이벤트 레이아웃 확보. 신속한 업데이트를 통해 마케팅 효율 극대화.",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        action: "PC, 모바일, 태블릿 전체에 대응하는 반응형 UI 최적화. IE8부터 오페라까지 아우르는 크로스브라우징 구현 및 웹 접근성 마크 획득을 위한 최종 마크업 검증 및 보완.",
      ...
      },
      {
        ...
        action: "복잡한 금융 상품 정보를 직관적으로 전달하는 PC/모바일 신규 UI 퍼블리싱. 하위 브라우저(IE8~11) 환경에서도 동일한 사용자 경험을 제공하는 레이아웃 설계.",
      ...
      },
      {
        ...
        action: "방대한 콘텐츠를 효율적으로 노출하기 위한 PC 메인 및 상세 페이지 리뉴얼. 다양한 브라우저 환경에서의 안정적인 렌더링 최적화.",
      ...
      },
      {
        ...
        action: "국문/영문 다국어 환경 대응 및 1024px/1600px 등 해상도 타입에 따른 가변형 반응형 UI 설계. 대규모 데이터 시각화를 고려한 견고한 마크업 구조 구축.",
  ...
  {
    period: "2013",
    company: "에스프리즘 / 라이트브레인",
    role: "대규모 커머스 및 통신 플랫폼 UI 구축",
    projects: [
      {
        title: "T open (SK텔레콤 오픈마켓) 신규 구축",
        ...
        action: "안드로이드 OS의 파편화된 해상도에 최적화된 모바일 마크업 설계. IE8부터 오페라까지 아우르는 광범위한 크로스브라우징 구현.",
        result: "기기별 일관된 사용자 경험 제공 및 안정적인 서비스 런칭 기여.",
      },
      {
        title: "현대카드 M포인트몰 리뉴얼",
        ...
        action: "IE7 하위 브라우저 환경에서도 현대카드 특유의 세련된 디자인 레이아웃을 무너짐 없이 구현. 결제 및 포인트 조회 등 복잡한 데이터 연동 화면 퍼블리싱.",
        result: "대규모 사용자 유입에 최적화된 견고한 UI 아키텍처 구축 및 현대카드의 디지털 브랜드 강화.",
      },
      {
        title: "LG U+ Shop(유플러스 샵) 리뉴얼 및 운영",
        ...
        action: "PC와 모바일 전반에 걸친 리뉴얼 퍼블리싱 전담. 특히 IE7~9 브라우저 환경에서의 안정적인 렌더링을 보장하는 크로스브라우징 최적화 및 상시 운영 기술 지원.",
    ...
    projects: [
      {
        ...
        action: "삼성의 표준 웹 가이드라인을 준수하여 정보 구조가 명확한 UI 구현. IE7~9 등 하위 브라우저에서도 깨짐 없는 레이아웃을 위한 크로스브라우징 최적화.",
        result: "교육 콘텐츠의 시각적 가독성을 확보하고, 다양한 사내 접속 환경에서 동일하게 출력되는 안정적인 마크업 구조 구축.",
      },
      {
        ...
        action: "경기도 온라인 평생학습 서비스인 '꿈날개'의 모바일 버전 신규 구축. 당시 급격히 보급되던 아이폰(iOS) 환경에 최적화된 모바일 웹 인터페이스 및 터치 기반 인터랙션 구현.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        action: "건설 현장의 탄소 배출량을 측정·관리하는 전문 시스템의 전체 UI 퍼블리싱 전담. IE6를 포함한 엔터프라이즈 환경 최적화.",
